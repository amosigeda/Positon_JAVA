...
var common_splitPage = function () {
    ...
    var splitPageHtml = function (divId, formId, totalRow, pageSize, pageNumber, totalPages, isSelectPage, isSelectSize, orderColunm, orderMode, currentPageCount, startRow, endRow) {
        ...
        splitStr += '<div class="dataTables_paginate paging_bootstrap"><ul class="pagination pagination-blue">';
        ...
        if (totalRow > 0) {
            splitStr += '<li>显示<strong>' + startRow + '至<strong>' + endRow + '</strong>条，';
        }
        splitStr += '共<strong>' + totalRow + '</strong>' + i18n_common_splitPage_records + '</li>';
    ...
    var splitPageLink = function (divId, formId, toPage) {
        ...
        if (typeof common_ajax != "undefined") {
