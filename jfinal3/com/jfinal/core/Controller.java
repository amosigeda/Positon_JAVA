...
public abstract class Controller {
    ...
    public <T> List<T> getModelList(Class<T> modelClass) {
        return Injector.injectModelList(modelClass, request, false);
    }

    public <T> List<T> getModelList(Class<T> modelClass, boolean skipConvertError) {
        return Injector.injectModelList(modelClass, request, skipConvertError);
    }
