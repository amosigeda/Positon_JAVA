...
public class User extends BaseModel<User> {
	...
	public static final String sqlId_findAllUsers = "platform.user.findAllUsers";
	...
	public static User cacheGetByUserName(String userName){
		...
		if(user == null){
            ...
            String sql = getSqlByBeetl("platform.user.fetchUser", param);
            user = User.dao.findFirst(sql, userName, userName, userName);
			if(user != null){
