...
public interface ConstantInit {
    ...
    public static final String CONFIG_PUBLIC_KEY = "config.publicKey";
    public static final String CONFIG_PRIVATE_KEY = "config.privateKey";
    public static final String CONFIG_NOVALIDPATH = "config.noValidPath";
    public static final String CONFIG_VALID_CODE_INTERVAL = "config.validCodeInterval";
    public static final String CONFIG_VALID_CODE_TIMES = "config.validCodeTimes";
    public static final String CONFIG_SMS_URL = "config.sms.url";
    public static final String CONFIG_SMS_USER = "config.sms.user";
    public static final String CONFIG_SMS_PWD = "config.sms.pwd";
    public static final String CONFIG_SMS_SIGN = "config.sms.sign";
    public static final String CONFIG_AMAP_LOC_URI = "config.amap.loc.uri";
    public static final String CONFIG_AREA_NAME_REPLACE_REGEX = "config.area.name.replace.regex";
    public static final String CONFIG_AREA_NAME_REPLACE_ITEMS = "config.area.name.replace.items";
}
