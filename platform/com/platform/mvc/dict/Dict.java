...
public class Dict extends BaseModel<Dict> {
    ...
    public static final String column_stockNum = "stockNum";
	...
	public static final String sqlId_childrenByParentNumber = "platform.dict.childrenByParentNumber";
    ...
    public String getMark() {
        return get(column_mark);
    }

    public void setMark(String mark) {
        set(column_mark,mark);
    }

    public String getPinyin() {
        return get(column_pinyin);
    }

    public void setPinyin(String pinyin) {
        set(column_pinyin,pinyin);
    }

    public String getPids() {
        return get(column_pids);
    }

    public void setPids(String pids) {
        set(column_pids,pids);
    }

    public Integer getStockNum() {
        return get(column_stockNum);
    }

    public void setStockNum(Integer stockNum) {
        this.set(column_stockNum, stockNum);
    }

    /**
	 * 根据主键查询字典，带国际化
	 * @param ids 主键
	 * @param i18nColumnSuffix 国际化参数
	 * @return
	 */
	...
	public List<Dict> cacheGetChild(String numbers){
		...
		if(dictList == null){
            ...
            ToolCache.set(ParamInitPlugin.cacheStart_dict_child + numbers, dictList);
		}
		return dictList;
	}
