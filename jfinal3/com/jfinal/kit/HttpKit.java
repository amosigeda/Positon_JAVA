...
public class HttpKit {
    ...
    private static HttpURLConnection getHttpConnection(String url, String method, Map<String, String> headers) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException {
        ...
        conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36");
    ...
    public static String post(String url, Map<String, String> queryParas) {
        ...
        try {
            ...
            String data = StringUtils.join(queryParas.entrySet().stream().map(x -> x.getKey() + "=" + x.getValue()).toArray(), "&");
